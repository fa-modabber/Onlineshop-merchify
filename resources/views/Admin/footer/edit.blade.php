...
@section('content')
    ...
    <form class="row gy-4 mb-5" action="{{ route('admin.footer.update') }}" method="POST">
        @csrf
        @method('PUT')
        <h3>ستون اول</h3>
        <div class="col-md-3">
        ...
        <div class="col-12">
            ...
            <input name="social_media_1" value="{{ $footer->telegram_link }}" class="form-control" />
            <div class="form-text text-danger">
                @error('telegram_link')
                    {{ $message }}
                @enderror
        ...
        <div class="col-12">
            ...
            <input name="social_media_2" value="{{ $footer->whatsapp_link }}" class="form-control" />
            <div class="form-text text-danger">
                @error('whatsapp_link')
                    {{ $message }}
                @enderror
        ...
        <div class="col-12">
            ...
            <input name="social_media_3" value="{{ $footer->instagram_link }}" class="form-control" />
            <div class="form-text text-danger">
        ...
        <div class="col-12">
            ...
            <input name="social_media_4" value="{{ $footer->youtube_link }}" class="form-control" />
            <div class="form-text text-danger">
                @error('youtube_link')
                    {{ $message }}
                @enderror
