            ...
            <li class="nav-item dropdown-center">
                ...
                <ul class="dropdown-menu sidebar-menu">
                    ...
                    {{ request()->is('sliders*') ? 'active' : '' }}
                        "
                            href="{{ route('admin.sliders.index') }}">اسلایدر صفحه اصلی</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                    {{ request()->is('features*') ? 'active' : '' }}
                        "
                            href="{{ route('admin.features.index') }}">بخش ویژگی ها</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                        {{ request()->is('about-us*') ? 'active' : '' }}
                        "
                            href="{{ route('admin.about-us.show') }}">بخش درباره ما</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                         {{ request()->is('footer*') ? 'active' : '' }}
                        "
                            href="{{ route('admin.footer.show') }}">بخش فوتر</a>
                    </li>
                </ul>
            </li>
